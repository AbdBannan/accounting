                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td class="row m-0">
                                            ...
                                            <a id="btn_delete" title="{{__("global.delete")}}" class="dropdown-item col-5 m-0 p-0" href="#" data-toggle="modal" data-target="#deleteConfirmModal" data-route="{{route("invoice.softDeleteProductMovementInvoice",$invoice->invoice_id)}}">
