                            ...
                            <tbody>
                                ...
                                @foreach ($deletedInvoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td class="row m-0">
                                            <a id="btn-restore" title="{{__("global.restore",[],session("lang"))}}" class="dropdown-item col-7 m-0 p-0" href="#" data-toggle="modal" data-target="#restoreConfirmModal" data-route="{{route("invoice.restoreProductMovementInvoice",$invoice->invoice_id)}}">
                                                <i class="fa fa-undo"></i>
                                            </a>
                                            <a id="btn-delete" title="{{__("global.delete",[],session("lang"))}}" class="dropdown-item col-5 m-0 p-0" href="#" data-toggle="modal" data-target="#deleteConfirmModal"  data-route="{{route("invoice.deleteProductMovementInvoice",$invoice->invoice_id)}}">
