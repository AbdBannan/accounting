        ...
        <div class="container">
            <div class="bg-gradient-light shadow" style="width: 40%;margin: auto;padding: 40px;">
                    ...
                    <div class="form-group">
                        <a id="btn_archive" data-toggle="modal" data-target="#archiveConfirmModal" type="submit" class="btn btn-block btn-outline-primary" >{{__("global.archive",[],session("lang"))}}</a>
                    </div>
            </div>
        </div>
