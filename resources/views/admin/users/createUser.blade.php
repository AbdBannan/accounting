                                ...
                                <form method="POST" class="user" action="{{ route('user.storeUser') }}" accept-charset="UTF-8" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input id="first_name" type="text" class="form-control form-control-user @error('first_name') is-invalid @enderror" placeholder="{{__("global.first_name")}}" name="first_name"  autocomplete="first_name" autofocus>
                                            @error('first_name')
                                        ...
                                        <div class="col-sm-6">
                                            <input id="last_name" type="text" class="form-control form-control-user @error('last_name') is-invalid @enderror" placeholder="{{__("global.last_name")}}" name="last_name" autocomplete="last_name" autofocus>
                                            @error('last_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ \App\functions\globalFunctions::fixTranslation($message) }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email"  placeholder="{{__("global.enter_email_address")}}" autocomplete="email">
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ \App\functions\globalFunctions::fixTranslation($message) }}</strong>
                                    </span>
                                    ...
                                    <input id="but_create_user" type="submit" class="btn btn-primary btn-user btn-block" value="{{ __('global.create') }}">
                                    <hr>
                                </form>
