<div class="form-group">
    ...
    <input tabindex="3" class="form-control" type="number" name="id" id="id" value="@yield("id",\App\Models\Account::withTrashed()->selectRaw("max(id) as id")->first()->id + 1)">
</div>
<div class="form-group">
    <label style="font-size: x-large" for="name" class="font-weight-bolder">{{__("global.name")}}</label>
    <input tabindex="4" class="form-control" type="text" name="name" id="name" value="">
</div>
<div class="form-group">
...
<div class="row">
    <div class="col-6 form-group">
        <select tabindex="6" class="form-control" name="account_type" id="account_type">
            <option value="0">{{__("global.secondary")}}</option>
            <option value="1">{{__("global.primary")}}</option>
        </select>
    </div>
    <div class="col-6 form-group">
        <select tabindex="7" class="form-control" name="group" id="group">
...
<div class="form-group">
    ...
    <textarea tabindex="8" class="form-control" name="notes" id="notes" value="" rows="3"></textarea>
</div>
