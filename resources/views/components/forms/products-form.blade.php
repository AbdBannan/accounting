<div class="row">
    ...
    <div class="form-group col-6">
        ...
        <div class="form-group">
            <select tabindex="2" id="store_id" name="store_id" class="form-control" >
...
<div class="form-group">
    ...
    <input tabindex="3" class="form-control" type="text" name="name" id="name" value="">
</div>

<div class="row">
    <div class="col-4 form-group">
        <label style="font-size: x-large" for="account_type" class="font-weight-bolder">{{__("global.type")}}</label>
        <select tabindex="4" class="form-control" name="account_type" id="account_type">
    ...
    <div class="col-4 form-group">
        ...
        <input tabindex="5" class="form-control" type="number" name="reference" id="reference" value="0">
    </div>
    <div class="col-4 form-group">
        <label style="font-size: x-large" for="is_raw" class="font-weight-bolder">{{__("global.is_raw_product")}}</label>
        <select tabindex="6" class="form-control" name="is_raw" id="is_raw">
...
<div class="form-group">
    ...
    <textarea tabindex="7" class="form-control" name="notes" id="notes" value="" rows="3"></textarea>
</div>
<div class="form-group">
    ...
    <input tabindex="8" id="product_image" type="file" class=" form-control-file" name="product_image" placeholder="profile image">
</div>
