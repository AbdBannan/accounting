            ...
            <form id="f" class="row" autocomplete="off">
                <div class="col-md-10 col-sm-12">
                    <div class="row">
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            @php
                                $invoice_id = App\Models\Journal::withTrashed()->where("detail",0)->whereIn("invoice_type",[1,2,3,4])->selectRaw("max(invoice_id) as mid")->get()[0]["mid"]+1;
                            @endphp
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                            <label style="font-size: large" for="second_part_name" >{{__("global.customer")}}</label>
                            <div class="input-group mb-3">
                                <input tabindex="1" form="form" id="second_part_name" name="second_part_name" type="text" placeholder="" class="form-control dropdown-toggle auto-save" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" value="@yield("second_part_name")"/>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label style="font-size: large" for="first_part_name" >{{__("global.other_part_account")}}</label>
                    ...
                    <div class="col-md-5 col-sm-12">
                        ...
                        <div>
                            <button tabindex="7" form="aa" id="btn_add_item_to_invoice" class="btn btn-outline-success">{{__("global.add")}}</button>
                ...
                <div class="form-group col-md-2 col-sm-12 text-center">
                    ...
                    <div id="qr_code_container" class="p-2" style="display: none">
                        {!! QrCode::size(100)->generate(route("uploadImage")."#invoice_$invoice_id") !!}
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable1" width="100%" cellspacing="0">
                    ...
                    <form id="form" action="@yield("form_route",route("invoice.storeInvoice",$invoiceType))" method="post" accept-charset="UTF-8" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        @yield("method")
                        <tbody id="body">
                            @yield("invoiceLines")
