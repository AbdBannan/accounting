...
{{--                        <th>{{__("global.pound",[],session("lang"))}}</th>--}}
                    ...
                    <form id="form" action="@yield("form_route",route("invoice.storeInvoice",$invoiceType))" autocomplete="false" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        @yield("method")
                        <tbody id="body">
                            @yield("invoiceLines")
