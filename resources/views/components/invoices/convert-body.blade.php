                ...
                <div class="col-md-10 col-sm-12">
                    <div class="row">
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            @php
                                $invoice_id = App\Models\Journal::withTrashed()->where("detail",1)->whereIn("invoice_type",[13,14])->selectRaw("max(invoice_id) as mid")->get()[0]["mid"]+1;
                            @endphp
                        ...
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            <input form="form" id="first_part_name" name="first_part_name" type="text" placeholder="" class="form-control dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" value="@yield("second_part_name")" />
                    ...
                    <div class="row" >
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            <input form="form" id="product_name" name="product_name" type="text" placeholder="" class="form-control dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" value="@yield("product_name")" />
                            <span class="invalid-feedback" role="alert">
                                <strong>{{__("messages.value_not_found")}}</strong>
                            </span>
