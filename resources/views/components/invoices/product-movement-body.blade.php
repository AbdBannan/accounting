                ...
                <div class="col-md-10 col-sm-12">
                    <div class="row">
                        <div class="form-group col-md-3 col-sm-12">
                            ...
                            <input form="form" id="invoice_id" name="invoice_id" min="0" type="number" class="form-control" readonly value="@yield("invoice_id",App\Models\Journal::where("detail",0)->whereIn("invoice_type",[11])->selectRaw("max(invoice_id) as mid")->get()[0]["mid"]+1)">
                        </div>
                        <div class="form-group col-md-3 col-sm-12">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                    ...
                    <form id="form" action="@yield("form-route",route("invoice.storeProductMovementInvoice"))" autocomplete="false" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        @yield("method")
                        <tbody id="body">
                        @yield("invoiceLines")
