...
{{--    <aside class="control-sidebar-dark" style="display: block;">--}}
        ...
        <h5>{{__("global.customize_view",[],session("lang"))}}</h5>
        <hr class="mb-2">
        <div class="row p-3 control-sidebar-content" style="">
            <div class="col-sm-12 col-md-4">
                <div class="mb-4">
                    ...
                    <span>{{__("global.dark_mode",[],session("lang"))}}</span>
                </div>
                <h6>{{__("global.header_options",[],session("lang"))}}</h6>
                <div class="mb-1">
                    ...
                    <span>{{__("global.fixed",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.drop_down_legacy_offset",[],session("lang"))}}</span>
                </div>
                <div class="mb-4">
                    <input name="no_border" type="checkbox" value="1" @if(isset($config["no_border"]) and $config["no_border"]) checked @endif class="mr-1">
                    <span>{{__("global.no_border",[],session("lang"))}}</span>
                </div>
                <h6>{{__("global.footer_options",[],session("lang"))}}</h6>
                <div class="mb-1">
                ...
                <h6>{{__("global.small_text_options",[],session("lang"))}}</h6>
                <div class="mb-1">
                    ...
                    <span>{{__("global.body",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.navbar",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                ...
                <div class="mb-1">
                    ...
                    <span>{{__("global.footer",[],session("lang"))}}</span>
                </div>
            </div>
            <div class="col-sm-12 col-md-4">
                <h6>{{__("global.sidebar_options",[],session("lang"))}}</h6>
                <div class="mb-1">
                    <input name="collapsed" type="checkbox" value="1" @if(isset($config["collapsed"]) and $config["collapsed"]) checked @endif class="mr-1">
                    <span>{{__("global.collapsed",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                ...
                <div class="mb-1">
                    ...
                    <span>{{__("global.sidebar_mini",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.sidebar_mini_md",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.sidebar_mini_xs",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                ...
                <div class="mb-1">
                    ...
                    <span>{{__("global.nav_child_indent",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.nav_child_hide_on_collapse",[],session("lang"))}}</span>
                </div>
                <div class="mb-1">
                    ...
                    <span>{{__("global.disable_hover/focus_auto-expand",[],session("lang"))}}</span>
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <h6>{{__("global.navbar_variants",[],session("lang"))}}</h6>
                <div class="d-flex">
                ...
                <h6>{{__("global.accent_color_variants",[],session("lang"))}}</h6>
                <div class="d-flex">
                ...
                <h6>{{__("global.dark_sidebar_variants",[],session("lang"))}}</h6>
                <div class="d-flex">
                ...
                <h6>{{__("global.light_sidebar_variants",[],session("lang"))}}</h6>
                <div class="d-flex">
                ...
                <h6>{{__("global.brand_logo_variants",[],session("lang"))}}</h6>
                <div class="d-flex">
