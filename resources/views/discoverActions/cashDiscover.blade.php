<x-masterLayout.master>
    @section("title")
        {{ __("global.cash_discover",[],session("lang")) }}
    @endsection
    @section('content')
        <div class="container">
            ...
            @if($actions != null)
                ...
                <div class="p-2">
                    <a href="{{route("discover.chooseListCashDiscover")}}" class="btn btn-outline-primary">{{__("global.discovers",[],session("lang"))}}</a>
            ...
            @else
                <div id="accordion" class="bg-gradient-light shadow p-md-5 p-sm-2" style="width: 50%;margin: auto;">
                    <div id="buttons">
                        <button data-target="#cashDiscoverUntilNowCollapse" class="btn btn-primary btn-block">{{__("global.discover_until_now",[],session("lang"))}}</button>
                        <button data-target="#cashDiscoverAfterLastCheckedPointCollapse" class="btn btn-primary btn-block">{{__("global.discover_until_last_checked_point",[],session("lang"))}}</button>
