...
class manufacturingController extends Controller
{
    ...
    public function index()
    {
        ...
        $invoices = Journal::where("detail", 0)->whereIn("invoice_type", [13,14])->selectRaw("invoice_id,first_part_name,sum(price * quantity) as value")->groupBy(["invoice_id", "first_part_name"])->orderBy("invoice_id")->get();
...
//sub of balance
                ...
                $this->validate(
                    $request,
                    [
                        "first_part_name_$ctr"=>Rule::exists("accounts","name")
                    ]
                );
