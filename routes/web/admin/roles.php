...
Route::middleware(["role:admin", "auth"])->group(function (){
    ...
    Route::get("role/{role}/attachPermission/{permission_id}","roleController@attachPermission")->name("role.attachPermission");
    Route::get("role/{role}/detachPermission/{permission_id}","roleController@detachPermission")->name("role.detachPermission");
});
